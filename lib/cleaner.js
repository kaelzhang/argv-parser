...
Cleaner.prototype.clean = function(value, callback) {
  var skema = this.skema;
  skema.validate(value, function (err) {
    if (err) {
      return callback(err);
    }

    skema.set(value, callback);
  });
};
